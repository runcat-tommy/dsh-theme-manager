  ...
  factory: (require) => {
    ...
    var STYLES = [
...

      {
        ...
        category: "china",
        colorScheme: "light",
        labelKey: "style.qinghua",
        descKey: "style.qinghuaDesc",
        swatch: ["#f4f7fa", "#edf2f7", "#2e5f8a", "#1c2b3a"],
        spec: {
          base: "#f4f7fa", layer1: "#fafcfd", layer2: "#edf2f7", layer3: "#e2eaf2", overlay: "#fdfefe", platform: "#eef3f8",
          label1: "#1c2b3a", label2: "#43556b", label3: "#6d8095", dimmed: "#9fb0c0", onDark: "#f4f7fa",
          brand: "#2e5f8a",
          btnPrimary: "#2e5f8a", btnPrimaryHover: "#3a6f9e", btnPrimaryDimmed: "#d3e0ec",
          btnInfo: "#3a7296", btnInfoHover: "#4a85ab",
          brandTertiary: "#d5e2ee",
          error: "#b05a52", error2: "#c57066",
          success: "#3e7a6e", success2: "#55908a", success3: "#d8e8e4",
          warn: "#b0884a", warn2: "#c49c5f", warn3: "#f0e5cd", warnLabel: "#8a6430",
          bubble: "#e8eff5", bubbleHi: "#d8e5ef",
          sidebar: "#eef3f8", sidebarActive: "#dde7f0", sidebarAccent: "#a9c2d6", sidebarHover: "#e9f0f6",
          toast: "#1c2b3a"
        }
      },
      {
        ...
        category: "china",
        colorScheme: "light",
        labelKey: "style.dunhuang",
        descKey: "style.dunhuangDesc",
        swatch: ["#f3e8d4", "#eee0c6", "#a4583f", "#3a2f24"],
        spec: {
          base: "#f3e8d4", layer1: "#f8f0e0", layer2: "#eee0c6", layer3: "#e4d2b2", overlay: "#faf4e6", platform: "#efe2c9",
          label1: "#3a2f24", label2: "#5f5140", label3: "#86765f", dimmed: "#ab9c85", onDark: "#f8f0e0",
          brand: "#a4583f",
          btnPrimary: "#a4583f", btnPrimaryHover: "#b8684d", btnPrimaryDimmed: "#e6d4c0",
          btnInfo: "#3a7d6e", btnInfoHover: "#4a8f80",
          brandTertiary: "#d9cbb2",
          error: "#b04a3a", error2: "#c75f4a",
          success: "#5f7d4a", success2: "#75905e", success3: "#e2e6d0",
          warn: "#c09a4a", warn2: "#d0aa5f", warn3: "#f0e2c0", warnLabel: "#8a6a28",
          bubble: "#eadfc6", bubbleHi: "#dccdb0",
          sidebar: "#efe3cc", sidebarActive: "#e2d2b4", sidebarAccent: "#c2ab7f", sidebarHover: "#eadfc6",
          toast: "#3a2f24"
        }
      },
      ...
      /* ---------------------------- DeepSeek 品牌 ---------------------------- */
      {
        ...
        category: "general",
        colorScheme: "light",
        labelKey: "style.deepseekBlue",
        descKey: "style.deepseekBlueDesc",
        swatch: ["#f3f6ff", "#e9eefd", "#4d6bfe", "#1b2340"],
        spec: {
          base: "#f3f6ff", layer1: "#fafbff", layer2: "#e9eefd", layer3: "#dce4fb", overlay: "#fdfdff", platform: "#eaeefb",
          label1: "#1b2340", label2: "#46507a", label3: "#6f7aa3", dimmed: "#a3abcc", onDark: "#fafbff",
          brand: "#4d6bfe",
          btnPrimary: "#4d6bfe", btnPrimaryHover: "#6380ff", btnPrimaryDimmed: "#d3ddfe",
          btnInfo: "#0ab8a8", btnInfoHover: "#22caba",
          brandTertiary: "#dbe3fe",
          error: "#e05a5a", error2: "#f07070",
          success: "#3f9e7a", success2: "#57b28e", success3: "#dcf0e8",
          warn: "#c9a04a", warn2: "#d8b35f", warn3: "#f3e8cd", warnLabel: "#8a6a28",
          bubble: "#e6ecfc", bubbleHi: "#d5e0fa",
          sidebar: "#eaeefb", sidebarActive: "#d8e1f9", sidebarAccent: "#9fb0e8", sidebarHover: "#e5eaf9",
          toast: "#1b2340"
        }
      },
      ...
      /* ------------------------------ 开发者 ------------------------------ */
      {
        ...
        category: "dev",
        colorScheme: "dark",
        labelKey: "style.catppuccinMocha",
        descKey: "style.catppuccinMochaDesc",
        swatch: ["#1e1e2e", "#313244", "#cba6f7", "#cdd6f4"],
        spec: {
          base: "#1e1e2e", layer1: "#262639", layer2: "#313244", layer3: "#3d3f58", overlay: "#2b2b40", platform: "#232338",
          label1: "#cdd6f4", label2: "#bac2de", label3: "#a6adc8", dimmed: "#7f849c", onDark: "#1e1e2e",
          brand: "#cba6f7",
          btnPrimary: "#cba6f7", btnPrimaryHover: "#d6bdf9", btnPrimaryDimmed: "#3a3b52",
          btnInfo: "#89b4fa", btnInfoHover: "#9ec2fb",
          brandTertiary: "#3a3b52",
          error: "#f38ba8", error2: "#f5a2b8",
          success: "#a6e3a1", success2: "#b5e8b1", success3: "#2f3f39",
          warn: "#f9e2af", warn2: "#fbe8bf", warn3: "#3d3a2e", warnLabel: "#f9e2af",
          bubble: "#262639", bubbleHi: "#313244",
          sidebar: "#181825", sidebarActive: "#313244", sidebarAccent: "#5b5d86", sidebarHover: "#202033",
          toast: "#313244"
        }
      },
      {
        ...
        category: "dev",
        colorScheme: "dark",
        labelKey: "style.dracula",
        descKey: "style.draculaDesc",
        swatch: ["#282a36", "#3b3d4e", "#bd93f9", "#f8f8f2"],
        spec: {
          base: "#282a36", layer1: "#2f313d", layer2: "#3a3d4d", layer3: "#44475a", overlay: "#31333f", platform: "#2c2e3a",
          label1: "#f8f8f2", label2: "#d6d8ea", label3: "#8f97bb", dimmed: "#6272a4", onDark: "#282a36",
          brand: "#bd93f9",
          btnPrimary: "#bd93f9", btnPrimaryHover: "#cba4fa", btnPrimaryDimmed: "#484b60",
          btnInfo: "#8be9fd", btnInfoHover: "#9fedfd",
          brandTertiary: "#4a4563",
          error: "#ff5555", error2: "#ff7777",
          success: "#50fa7b", success2: "#6dfb93", success3: "#2f4a3c",
          warn: "#f1fa8c", warn2: "#f4fb9f", warn3: "#4a4a3a", warnLabel: "#f1fa8c",
          bubble: "#31333f", bubbleHi: "#3b3d4e",
          sidebar: "#232530", sidebarActive: "#383b4c", sidebarAccent: "#6272a4", sidebarHover: "#2b2d39",
          toast: "#3b3d4e"
        }
      },
      {
        ...
        category: "dev",
        colorScheme: "dark",
        labelKey: "style.tokyoNight",
        descKey: "style.tokyoNightDesc",
        swatch: ["#1a1b26", "#292e42", "#7aa2f7", "#c0caf5"],
        spec: {
          base: "#1a1b26", layer1: "#1f2232", layer2: "#292e42", layer3: "#303755", overlay: "#23273a", platform: "#1e2130",
          label1: "#c0caf5", label2: "#a9b1d6", label3: "#7882a8", dimmed: "#565f89", onDark: "#1a1b26",
          brand: "#7aa2f7",
          btnPrimary: "#7aa2f7", btnPrimaryHover: "#8fb0f9", btnPrimaryDimmed: "#39456d",
          btnInfo: "#7dcfff", btnInfoHover: "#92d9ff",
          brandTertiary: "#39456d",
          error: "#f7768e", error2: "#f98ba0",
          success: "#9ece6a", success2: "#aed988", success3: "#35402c",
          warn: "#e0af68", warn2: "#e6bd7f", warn3: "#4a3d2c", warnLabel: "#e0af68",
          bubble: "#1f2232", bubbleHi: "#292e42",
          sidebar: "#171823", sidebarActive: "#252a3f", sidebarAccent: "#565f89", sidebarHover: "#1c1f2e",
          toast: "#292e42"
        }
      },
      {
        ...
        colorScheme: "dark",
        labelKey: "style.nord",
        descKey: "style.nordDesc",
        swatch: ["#2e3440", "#3b4252", "#88c0d0", "#eceff4"],
        spec: {
          base: "#2e3440", layer1: "#343b4a", layer2: "#3b4252", layer3: "#434c5e", overlay: "#363d4d", platform: "#313846",
          label1: "#eceff4", label2: "#e5e9f0", label3: "#c3cbd9", dimmed: "#8e97ab", onDark: "#2e3440",
          brand: "#88c0d0",
          btnPrimary: "#88c0d0", btnPrimaryHover: "#9ad2e0", btnPrimaryDimmed: "#3e4a5f",
          btnInfo: "#81a1c1", btnInfoHover: "#93b3d1",
          brandTertiary: "#3e4a5f",
          error: "#bf616a", error2: "#cc757e",
          success: "#a3be8c", success2: "#b3caa0", success3: "#3a473c",
          warn: "#ebcb8b", warn2: "#f0d69e", warn3: "#4a4538", warnLabel: "#ebcb8b",
          bubble: "#343b4a", bubbleHi: "#3b4252",
          sidebar: "#2a303b", sidebarActive: "#3b4252", sidebarAccent: "#5e81ac", sidebarHover: "#303744",
          toast: "#3b4252"
        }
      },
      {
        ...
        category: "dev",
        colorScheme: "dark",
        labelKey: "style.gruvbox",
        descKey: "style.gruvboxDesc",
        swatch: ["#282828", "#3c3836", "#d79921", "#fbf1c7"],
        spec: {
          base: "#282828", layer1: "#33302e", layer2: "#3c3836", layer3: "#504945", overlay: "#2e2b29", platform: "#302d2b",
          label1: "#fbf1c7", label2: "#ebdbb2", label3: "#d5c4a1", dimmed: "#928374", onDark: "#282828",
          brand: "#d79921",
          btnPrimary: "#d79921", btnPrimaryHover: "#e3a83c", btnPrimaryDimmed: "#4a443b",
          btnInfo: "#83a598", btnInfoHover: "#93b0a5",
          brandTertiary: "#4a443b",
          error: "#fb4934", error2: "#fc6553",
          success: "#b8bb26", success2: "#c3c63d", success3: "#3e4128",
          warn: "#fabd2f", warn2: "#fbc94f", warn3: "#4a4430", warnLabel: "#fabd2f",
          bubble: "#33302e", bubbleHi: "#3c3836",
          sidebar: "#232323", sidebarActive: "#383430", sidebarAccent: "#7c6f64", sidebarHover: "#2e2b29",
          toast: "#3c3836"
        }
      },
      {
        ...
        category: "dev",
        colorScheme: "dark",
        labelKey: "style.oneDark",
        descKey: "style.oneDarkDesc",
        swatch: ["#282c34", "#353a44", "#61afef", "#c8ccd4"],
        spec: {
          base: "#282c34", layer1: "#2d313a", layer2: "#353a44", layer3: "#3e4451", overlay: "#30343e", platform: "#2b2f37",
          label1: "#c8ccd4", label2: "#abb2bf", label3: "#8a93a0", dimmed: "#5c6370", onDark: "#282c34",
          brand: "#61afef",
          btnPrimary: "#61afef", btnPrimaryHover: "#74bbf2", btnPrimaryDimmed: "#3c4659",
          btnInfo: "#56b6c2", btnInfoHover: "#68c2ce",
          brandTertiary: "#3c4659",
          error: "#e06c75", error2: "#e6828a",
          success: "#98c379", success2: "#a6cf89", success3: "#3a4430",
          warn: "#e5c07b", warn2: "#eacb90", warn3: "#47402c", warnLabel: "#e5c07b",
          bubble: "#2f333d", bubbleHi: "#353a44",
          sidebar: "#24272e", sidebarActive: "#353a44", sidebarAccent: "#4b5263", sidebarHover: "#2b2f37",
          toast: "#353a44"
        }
      },
      {
        ...
        category: "dev",
        colorScheme: "dark",
        labelKey: "style.solarizedDark",
        descKey: "style.solarizedDarkDesc",
        swatch: ["#002b36", "#073642", "#268bd2", "#93a1a1"],
        spec: {
          base: "#002b36", layer1: "#052f3c", layer2: "#073642", layer3: "#0d4554", overlay: "#06313e", platform: "#042d3a",
          label1: "#93a1a1", label2: "#839496", label3: "#657b83", dimmed: "#586e75", onDark: "#002b36",
          brand: "#268bd2",
          btnPrimary: "#268bd2", btnPrimaryHover: "#3798dc", btnPrimaryDimmed: "#1d3b4c",
          btnInfo: "#2aa198", btnInfoHover: "#36afa6",
          brandTertiary: "#1d3b4c",
          error: "#dc322f", error2: "#e04b48",
          success: "#859900", success2: "#94a815", success3: "#2b3316",
          warn: "#b58900", warn2: "#c29614", warn3: "#3a3318", warnLabel: "#c29614",
          bubble: "#073642", bubbleHi: "#0b4250",
          sidebar: "#00232d", sidebarActive: "#073642", sidebarAccent: "#586e75", sidebarHover: "#032b36",
          toast: "#073642"
        }
      },
      {
        ...
        category: "dev",
        colorScheme: "dark",
        labelKey: "style.ayuMirage",
        descKey: "style.ayuMirageDesc",
        swatch: ["#1f2430", "#2c3343", "#73d0ff", "#cbccc6"],
        spec: {
          base: "#1f2430", layer1: "#242a38", layer2: "#2c3343", layer3: "#343f4e", overlay: "#262c3b", platform: "#222837",
          label1: "#cbccc6", label2: "#a6aa9c", label3: "#707a8c", dimmed: "#5c6773", onDark: "#1f2430",
          brand: "#73d0ff",
          btnPrimary: "#73d0ff", btnPrimaryHover: "#8ad9ff", btnPrimaryDimmed: "#32465a",
          btnInfo: "#95e6cb", btnInfoHover: "#a9ecd5",
          brandTertiary: "#32465a",
          error: "#f28779", error2: "#f49b90",
          success: "#aad94c", success2: "#b6e065", success3: "#3a4326",
          warn: "#ffd580", warn2: "#ffdf99", warn3: "#4a4230", warnLabel: "#ffd580",
          bubble: "#252b3a", bubbleHi: "#2c3343",
          sidebar: "#1b202b", sidebarActive: "#2c3343", sidebarAccent: "#5c6773", sidebarHover: "#222837",
          toast: "#2c3343"
        }
      },
      ...
      /* ------------------------------ 强烈对比 ------------------------------ */
      {
        id: "contrast-black-gold",
        category: "contrast",
        colorScheme: "dark",
        labelKey: "style.blackGold",
        descKey: "style.blackGoldDesc",
        swatch: ["#0d0d0c", "#201e1b", "#e8b64c", "#f5f1e6"],
        spec: {
          base: "#0d0d0c", layer1: "#171614", layer2: "#201e1b", layer3: "#2a2723", overlay: "#141312", platform: "#171614",
          label1: "#f5f1e6", label2: "#cfc8b8", label3: "#9d9482", dimmed: "#6d6657", onDark: "#0d0d0c",
          brand: "#e8b64c",
          btnPrimary: "#e8b64c", btnPrimaryHover: "#f2c463", btnPrimaryDimmed: "#3a3020",
          btnInfo: "#a8832a", btnInfoHover: "#bd9436",
          brandTertiary: "#2a251a",
          error: "#e0563f", error2: "#f06a50",
          success: "#9ab35a", success2: "#abc96b", success3: "#2a3322",
          warn: "#f0a832", warn2: "#f5b84f", warn3: "#3a2f1c", warnLabel: "#f0a832",
          bubble: "#171614", bubbleHi: "#211e1a",
          sidebar: "#0b0b0a", sidebarActive: "#221f1b", sidebarAccent: "#6b5a2e", sidebarHover: "#141312",
          toast: "#221f1b"
        }
      },
      {
        id: "contrast-red-black",
        category: "contrast",
        colorScheme: "dark",
        labelKey: "style.redBlack",
        descKey: "style.redBlackDesc",
        swatch: ["#120e0e", "#251a1a", "#e02727", "#f7ecea"],
        spec: {
          base: "#120e0e", layer1: "#1b1414", layer2: "#251a1a", layer3: "#2f2121", overlay: "#181111", platform: "#1b1414",
          label1: "#f7ecea", label2: "#d3b9b5", label3: "#a2827d", dimmed: "#715a56", onDark: "#ffffff",
          brand: "#e02727",
          btnPrimary: "#e02727", btnPrimaryHover: "#f03434", btnPrimaryDimmed: "#4a2020",
          btnInfo: "#ececec", btnInfoHover: "#ffffff",
          brandTertiary: "#3a1e1e",
          error: "#ff5a48", error2: "#ff7562",
          success: "#53c46b", success2: "#6cd684", success3: "#1e3323",
          warn: "#ffb02e", warn2: "#ffc050", warn3: "#3a2f18", warnLabel: "#ffb02e",
          bubble: "#1b1414", bubbleHi: "#251a1a",
          sidebar: "#0f0b0b", sidebarActive: "#2a1b1b", sidebarAccent: "#8a2e26", sidebarHover: "#181111",
          toast: "#251a1a"
        }
      },
      {
        ...
        category: "contrast",
        colorScheme: "dark",
        labelKey: "style.yellowBlack",
        descKey: "style.yellowBlackDesc",
        swatch: ["#121210", "#262620", "#ffd21f", "#f7f6e8"],
        spec: {
          base: "#121210", layer1: "#1c1c18", layer2: "#262620", layer3: "#30302a", overlay: "#191916", platform: "#1c1c18",
          label1: "#f7f6e8", label2: "#d0cdb0", label3: "#9d987a", dimmed: "#6e6a52", onDark: "#121210",
          brand: "#ffd21f",
          btnPrimary: "#ffd21f", btnPrimaryHover: "#ffdc4a", btnPrimaryDimmed: "#4a4218",
          btnInfo: "#f0f0e8", btnInfoHover: "#ffffff",
          brandTertiary: "#3a3518",
          error: "#ff5340", error2: "#ff6b56",
          success: "#8ad653", success2: "#a0e06b", success3: "#28331d",
          warn: "#ff9e1f", warn2: "#ffb13f", warn3: "#3a2f18", warnLabel: "#ff9e1f",
          bubble: "#1c1c18", bubbleHi: "#282820",
          sidebar: "#0e0e0c", sidebarActive: "#2a2a20", sidebarAccent: "#8a7a1e", sidebarHover: "#191916",
          toast: "#2a2a20"
        }
      },
      {
        id: "contrast-pink-black",
        category: "contrast",
        colorScheme: "dark",
        labelKey: "style.pinkBlack",
        descKey: "style.pinkBlackDesc",
        swatch: ["#140e13", "#291c26", "#ff2d8a", "#fbeef4"],
        spec: {
          base: "#140e13", layer1: "#1e151c", layer2: "#291c26", layer3: "#332331", overlay: "#1b1219", platform: "#1e151c",
          label1: "#fbeef4", label2: "#e0c2cf", label3: "#b894a6", dimmed: "#8a6c7a", onDark: "#140e13",
          brand: "#ff2d8a",
          btnPrimary: "#ff2d8a", btnPrimaryHover: "#ff4d9c", btnPrimaryDimmed: "#4a1f38",
          btnInfo: "#f7f2f5", btnInfoHover: "#ffffff",
          brandTertiary: "#3a1f30",
          error: "#ff4d5a", error2: "#ff6a75",
          success: "#57d67e", success2: "#70e394", success3: "#1e3326",
          warn: "#ffb020", warn2: "#ffc44a", warn3: "#3a3018", warnLabel: "#ffb020",
          bubble: "#1e151c", bubbleHi: "#291c26",
          sidebar: "#110b10", sidebarActive: "#2e1d27", sidebarAccent: "#8a2d5e", sidebarHover: "#1b1219",
          toast: "#2e1d27"
        }
      },
      {
        id: "contrast-acid-green",
        category: "contrast",
        colorScheme: "dark",
        labelKey: "style.acidGreen",
        descKey: "style.acidGreenDesc",
        swatch: ["#0d100a", "#1f2417", "#c8ff2e", "#f2f6e8"],
        spec: {
          base: "#0d100a", layer1: "#161a11", layer2: "#1f2417", layer3: "#292f1e", overlay: "#13170f", platform: "#161a11",
          label1: "#f2f6e8", label2: "#c2cbae", label3: "#8b967c", dimmed: "#5d6652", onDark: "#0d100a",
          brand: "#c8ff2e",
          btnPrimary: "#c8ff2e", btnPrimaryHover: "#d4ff55", btnPrimaryDimmed: "#3a4218",
          btnInfo: "#00e6b8", btnInfoHover: "#1ff0c6",
          brandTertiary: "#2a3018",
          error: "#ff4a3d", error2: "#ff6757",
          success: "#34d98a", success2: "#4fe5a0", success3: "#173226",
          warn: "#ffb020", warn2: "#ffc44a", warn3: "#3a3018", warnLabel: "#ffb020",
          bubble: "#161a11", bubbleHi: "#222817",
          sidebar: "#0a0d07", sidebarActive: "#262d1a", sidebarAccent: "#67701f", sidebarHover: "#13170f",
          toast: "#262d1a"
        }
      },
      {
        id: "contrast-teal-orange",
        category: "contrast",
        colorScheme: "dark",
        labelKey: "style.tealOrange",
        descKey: "style.tealOrangeDesc",
        swatch: ["#0d1414", "#1d2a2b", "#ff7a1f", "#eaf2f0"],
        spec: {
          base: "#0d1414", layer1: "#151f20", layer2: "#1d2a2b", layer3: "#263636", overlay: "#121b1c", platform: "#151f20",
          label1: "#eaf2f0", label2: "#bccfcc", label3: "#8da6a3", dimmed: "#607672", onDark: "#0d1414",
          brand: "#ff7a1f",
          btnPrimary: "#ff7a1f", btnPrimaryHover: "#ff9145", btnPrimaryDimmed: "#4a2c18",
          btnInfo: "#00c9a7", btnInfoHover: "#14dbac",
          brandTertiary: "#3a2c1e",
          error: "#ff5a4a", error2: "#ff7562",
          success: "#3fc47f", success2: "#55d495", success3: "#173326",
          warn: "#ffb020", warn2: "#ffc44a", warn3: "#3a3018", warnLabel: "#ffb020",
          bubble: "#151f20", bubbleHi: "#1d2a2b",
          sidebar: "#0a1111", sidebarActive: "#213132", sidebarAccent: "#8a4a1a", sidebarHover: "#121b1c",
          toast: "#213132"
        }
      },
      {
        id: "contrast-mondrian",
        category: "contrast",
        colorScheme: "light",
        labelKey: "style.mondrian",
        descKey: "style.mondrianDesc",
        swatch: ["#f4f2ec", "#ece9e0", "#e03025", "#1b1b1c"],
        spec: {
          base: "#f4f2ec", layer1: "#faf9f5", layer2: "#ece9e0", layer3: "#e0dcd0", overlay: "#fdfcf9", platform: "#ece9e1",
          label1: "#1b1b1c", label2: "#4a4a4c", label3: "#7a7a7d", dimmed: "#a9a9ab", onDark: "#ffffff",
          brand: "#e03025",
          btnPrimary: "#e03025", btnPrimaryHover: "#e84a3f", btnPrimaryDimmed: "#f2c9c4",
          btnInfo: "#2d4c9c", btnInfoHover: "#3a5cb0",
          brandTertiary: "#f0ddd9",
          error: "#d02630", error2: "#e04048",
          success: "#4f8a4a", success2: "#65a15e", success3: "#e0ebe0",
          warn: "#d4a017", warn2: "#e0b22e", warn3: "#f2e6c4", warnLabel: "#8a6a10",
          bubble: "#ece9e1", bubbleHi: "#ddd9cc",
          sidebar: "#ece9e1", sidebarActive: "#ddd8ca", sidebarAccent: "#2d4c9c", sidebarHover: "#e8e5dc",
          toast: "#1b1b1c"
        }
      }
    ];
    ...
    var CATEGORIES = [
      ...
      { id: "dev", labelKey: "cat.dev" },
      { id: "contrast", labelKey: "cat.contrast" },
    ...
    var zh = {
      ...
      "style.qinghua": "青花瓷风格",
      "style.qinghuaDesc": "白瓷釉底 · 钴蓝纹样 · 描金点缀",
      "style.dunhuang": "敦煌飞天风格",
      "style.dunhuangDesc": "壁画土红 · 石绿 · 青金 · 土黄",
      "style.deepseekBlue": "DeepSeek 深海蓝",
      "style.deepseekBlueDesc": "海雾白底 · 深海蓝主色 · 青绿点缀",
      "style.catppuccinMocha": "Catppuccin Mocha",
      "style.catppuccinMochaDesc": "薰衣草紫 · 午夜深蓝 · 奶油白",
      "style.dracula": "德古拉",
      "style.draculaDesc": "深紫黑底 · 紫粉主色 · 翡翠绿点缀",
      "style.tokyoNight": "东京之夜",
      "style.tokyoNightDesc": "深靛夜空 · 电光蓝 · 霓虹青",
      "style.nord": "北极冰川",
      "style.nordDesc": "极夜蓝灰 · 冰川蓝 · 极光绿",
      "style.gruvbox": "复古暖黄",
      "style.gruvboxDesc": "暖黑底 · 麦黄主色 · 复古橙",
      "style.oneDark": "One Dark",
      "style.oneDarkDesc": "深灰蓝底 · 电光蓝 · 柔和语法色",
      "style.solarizedDark": "Solarized 深色",
      "style.solarizedDarkDesc": "深海蓝黑底 · 科学蓝青 · 克制度高",
      "style.ayuMirage": "Ayu Mirage",
      "style.ayuMirageDesc": "沙丘蓝灰 · 天蓝主色 · 柔和青绿",
      "style.blackGold": "黑金对比",
      "style.blackGoldDesc": "曜黑底 · 鎏金主色 · 白蜡文字",
      "style.redBlack": "红黑对比",
      "style.redBlackDesc": "墨黑底 · 信号红主色 · 纯白副键",
      "style.yellowBlack": "黄黑警示",
      "style.yellowBlackDesc": "曜黑底 · 警示黄主色 · 黑白副键",
      "style.pinkBlack": "粉黑对比",
      "style.pinkBlackDesc": "曜黑底 · 荧光粉主色 · 纯白副键",
      "style.acidGreen": "荧光绿酸",
      "style.acidGreenDesc": "暗绿黑底 · 酸性荧光绿 · 薄荷青",
      "style.tealOrange": "青橙互补",
      "style.tealOrangeDesc": "墨青底 · 火焰橙主色 · 电光青副键",
      "style.mondrian": "蒙德里安",
      "style.mondrianDesc": "米白底 · 红黄蓝原色块 · 黑色分割线",
      "apply": "使用",
      "active": "使用中",
      "restore": "恢复默认外观",
      "done": "完成",
    ...
    var en = {
      ...
      "style.qinghua": "Blue-and-white Porcelain",
      "style.qinghuaDesc": "White glaze · cobalt blue · gilded accents",
      "style.dunhuang": "Dunhuang Flying Apsaras",
      "style.dunhuangDesc": "Mural ochre-red · malachite green · lapis · earth yellow",
      "style.deepseekBlue": "DeepSeek Deep Blue",
      "style.deepseekBlueDesc": "Sea-mist white · deep-sea blue · teal accents",
      "style.catppuccinMocha": "Catppuccin Mocha",
      "style.catppuccinMochaDesc": "Mauve · midnight navy · cream",
      "style.dracula": "Dracula",
      "style.draculaDesc": "Deep purple-black · violet-pink · emerald accents",
      "style.tokyoNight": "Tokyo Night",
      "style.tokyoNightDesc": "Indigo night · electric blue · neon cyan",
      "style.nord": "Nord",
      "style.nordDesc": "Polar night · glacier frost · aurora green",
      "style.gruvbox": "Gruvbox",
      "style.gruvboxDesc": "Warm black · wheat yellow · retro orange",
      "style.oneDark": "One Dark",
      "style.oneDarkDesc": "Slate grey · electric blue · muted syntax colors",
      "style.solarizedDark": "Solarized Dark",
      "style.solarizedDarkDesc": "Deep teal-black · scientific cyan-blue · restrained",
      "style.ayuMirage": "Ayu Mirage",
      "style.ayuMirageDesc": "Dune blue-grey · sky blue · soft teal",
      "style.blackGold": "Black & Gold",
      "style.blackGoldDesc": "Obsidian black · gilded gold · candle-light text",
      "style.redBlack": "Red & Black",
      "style.redBlackDesc": "Ink black · signal red · pure-white secondary",
      "style.yellowBlack": "Yellow & Black",
      "style.yellowBlackDesc": "Obsidian black · safety yellow · monochrome secondary",
      "style.pinkBlack": "Pink & Black",
      "style.pinkBlackDesc": "Obsidian black · hot pink · pure-white secondary",
      "style.acidGreen": "Acid Green",
      "style.acidGreenDesc": "Dark green-black · acid lime · mint teal",
      "style.tealOrange": "Teal & Orange",
      "style.tealOrangeDesc": "Ink teal · flame orange · electric teal secondary",
      "style.mondrian": "Mondrian",
      "style.mondrianDesc": "Off-white · primary red-yellow-blue blocks · black grid",
      "apply": "Apply",
      "active": "Active",
